      ...
      <div className='flex flex-wrap gap-2 mb-4'>
        {['pending', 'confirmed', 'completed', 'cancelled'].map(status => (
            <button
                ...
                className={`px-4 py-2 text-sm font-semibold rounded-full capitalize transition-all duration-300 ${
    ...
    <div className='p-4'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-3 gap-6'>
          <div className='p-6 bg-blue-50 dark:bg-slate-900 rounded-lg shadow-sm border border-blue-200 dark:border-blue-700'>
              <p className='text-3xl font-bold text-blue-800 dark:text-blue-200'>50</p>
              <p className='text-sm font-medium text-blue-600 dark:text-blue-300'>Total Bookings (Lifetime)</p>
          </div>
          <div className='p-6 bg-green-50 dark:bg-slate-900 rounded-lg shadow-sm border border-green-200 dark:border-green-700'>
              <p className='text-3xl font-bold text-green-800 dark:text-green-200'>$5,200</p>
              <p className='text-sm font-medium text-green-600 dark:text-green-300'>Total Revenue (Est.)</p>
          </div>
          <div className='p-6 bg-yellow-50 dark:bg-slate-900 rounded-lg shadow-sm border border-yellow-200 dark:border-yellow-700'>
              <p className='text-3xl font-bold text-yellow-800 dark:text-yellow-200'>{roleProfile.ratingAvg.toFixed(1)} <FaStar className='inline w-6 h-6'/></p>
              <p className='text-sm font-medium text-yellow-600 dark:text-yellow-300'>Average Rating ({roleProfile.reviewCount})</p>
          </div>
      </div>
    </div>
  );
